...
const demo = setupDemoReel('Particles 2D')
...
const controls = createControlsPane('Particles 2D', { ...DEFAULTS }, (pane, p) => {
...
// the renderer's tone mapping + sRGB conversion to screen.
