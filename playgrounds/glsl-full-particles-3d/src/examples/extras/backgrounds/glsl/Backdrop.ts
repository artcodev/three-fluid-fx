...
export class Backdrop implements Background {
  ...
  setTheme(theme: BackdropTheme): void {
    ...
    ;(u.uLightAColor.value as Color).set(t.lightA)
    ;(u.uLightBColor.value as Color).set(t.lightB)
    ;(u.uBaseColor.value as Color).set(t.base)
  ...
  update(_dt: number, elapsed: number): void {
    ...
    ;(u.uCameraPos.value as Vector3).copy(this.camera.position)
    ...
    ;(u.uLightAPos.value as Vector3).set(x, y, -1.5)
    ;(u.uLightBPos.value as Vector3).set(-x, -y, -1.5)
  }
