...
class FluidSimulation {
  ...
  constructor(renderer, options = {}) {
    ...
    this.mesh = new three.Mesh(this.geometry, void 0);
    ...
    this.splatGeometry.setIndex(new three.Uint16BufferAttribute(new Uint16Array([0, 1, 2, 1, 3, 2]), 1));
    this.splatMesh = new three.Mesh(this.splatGeometry, void 0);
...
class FluidEffectPass extends Pass {
  ...
  constructor(fragmentShader, uniforms, options = {}) {
    ...
    this.opacityMaterial = new three.ShaderMaterial({
      ...
      uniforms: {
        tBase: new three.Uniform(null),
        tOverlay: new three.Uniform(null),
    ...
    this.opacityTarget = new three.WebGLRenderTarget(1, 1, {
      depthBuffer: false,
      stencilBuffer: false
    });
  }
...
class ChromaticDistortionPass extends FluidEffectPass {
  constructor(fluid) {
    super(FRAGMENT$h, {
      ...
      tFluid: new three.Uniform(null),
      uIntensity: new three.Uniform(1),
      uTexel: new three.Uniform(new three.Vector2(1 / 512, 1 / 512))
    });
    this.fluid = fluid;
  }
  fluid;
...
class DefaultOverlayPass extends FluidEffectPass {
  constructor(fluid) {
    const initialColor = new three.Color(0.85, 0.95, 1);
    super(
      FRAGMENT$e,
      {
        tDiffuse: new three.Uniform(null),
        tFluid: new three.Uniform(null),
        tDye: new three.Uniform(null),
        uIntensity: new three.Uniform(1),
        uTexel: new three.Uniform(new three.Vector2(1 / 512, 1 / 512)),
        uCursorColor: new three.Uniform(initialColor.clone()),
...
class VelocityOverlayPass extends FluidEffectPass {
  constructor(fluid) {
    super(
      ...
      {
        tDiffuse: new three.Uniform(null),
        tVelocity: new three.Uniform(null),
        uIntensity: new three.Uniform(1)
      }
    );
    this.fluid = fluid;
...
class DensityTintOverlayPass extends FluidEffectPass {
  constructor(fluid) {
    const initialColor = new three.Color(0.1, 0.42, 0.36);
    super(FRAGMENT, {
      tDiffuse: new three.Uniform(null),
      tFluid: new three.Uniform(null),
      uIntensity: new three.Uniform(0.14),
      uTint: new three.Uniform(initialColor.clone())
    });
    this.fluid = fluid;
...
exports.ArtInkOverlayPass = ArtInkOverlayPass;
exports.BurnOverlayPass = BurnOverlayPass;
exports.ChromaticDistortionPass = ChromaticDistortionPass;
exports.ColorWaterOverlayPass = ColorWaterOverlayPass;
exports.ColorfulOverlayPass = ColorfulOverlayPass;
exports.DefaultOverlayPass = DefaultOverlayPass;
exports.DensityTintOverlayPass = DensityTintOverlayPass;
exports.FLUID_PROFILES = FLUID_PROFILES;
exports.FULLSCREEN_VERTEX = FULLSCREEN_VERTEX;
exports.FluidEffectPass = FluidEffectPass;
exports.FluidSimulation = FluidSimulation;
exports.FullscreenPass = FullscreenPass;
exports.GlazeOverlayPass = GlazeOverlayPass;
exports.LiquidLensOverlayPass = LiquidLensOverlayPass;
exports.OilOverlayPass = OilOverlayPass;
exports.RGBShiftDistortionPass = RGBShiftDistortionPass;
exports.RainbowFishOverlayPass = RainbowFishOverlayPass;
exports.RainbowInkOverlayPass = RainbowInkOverlayPass;
exports.SimpleDistortionPass = SimpleDistortionPass;
exports.SmokeOverlayPass = SmokeOverlayPass;
exports.TrailOverlayPass = TrailOverlayPass;
exports.VelocityOverlayPass = VelocityOverlayPass;
exports.VolumeCursorOverlayPass = VolumeCursorOverlayPass;
exports.WaterCausticsDistortionPass = WaterCausticsDistortionPass;
exports.WaterDistortionPass = WaterDistortionPass;
