...
function makeStorageTarget(size, name) {
...
function makeStorageDouble(size, name) {
  return {
...
function createBillboardGeometry(size) {
...
export function createWGSLFlowParticles(renderer, options) {
  return new WGSLFlowParticles(renderer, options)
}
class WGSLFlowParticles {
  constructor(renderer, options) {
    ...
    Object.defineProperty(this, 'linearSampler', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0,
    ...
    Object.defineProperty(this, 'externalTextures', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new Map(),
    })
    Object.defineProperty(this, 'externalTextureDisposeHandlers', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new Map(),
    })
    Object.defineProperty(this, 'ownedTextureIds', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new Set(),
    ...
    Object.defineProperty(this, 'params', {
      ...
      configurable: true,
      writable: true,
      value: new Float32Array(UNIFORM_FLOATS),
    })
    Object.defineProperty(this, 'pointSizeNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: uniform(DEFAULT_POINT_SIZE),
    })
    ...
    Object.defineProperty(this, 'positionTextureNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0,
    })
    Object.defineProperty(this, 'velocityTextureNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0,
    ...
    Object.defineProperty(this, 'modelRotationMatrix', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: new Matrix4(),
    })
    Object.defineProperty(this, 'destinationUpload', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0,
    })
    Object.defineProperty(this, 'frameUniformIndex', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: 0,
    ...
    this.positionTextureNode = textureFn(this.position.read)
    this.velocityTextureNode = textureFn(this.velocity.read)
  ...
  createMesh() {
    ...
    const texSizeUint = uint(this.size)
    const texSizeFloat = float(this.size)
    ...
    const positionTex = this.positionTextureNode
    const velocityTex = this.velocityTextureNode
    const attributeTex = textureFn(this.attributes)
    ...
    const worldSize = this.pointSizeNode
      .mul(attr.x.clamp(0.65, 1.6))
      .mul(BILLBOARD_WORLD_UNITS_PER_POINT_SIZE)
    const offset = this.cameraRightLocalNode
      .mul(corner.x)
      .add(this.cameraUpLocalNode.mul(corner.y))
      .mul(worldSize)
    ...
    const particlePalette = palette.toVarying('vFlowParticlePalette')
    const particleColor = palette.mul(emissionStrength).toVarying('vFlowParticleColor')
  ...
  createPipelines() {
    ...
    return entries.reduce((pipelines, [name, code]) => {
  ...
  updateRenderUniforms(step) {
    ...
    this.pointSizeNode.value = step.pointSize
  }
  refreshRenderNodes() {
  ...
  dispatch(encoder, name, resources) {
...
function getWebGPUBackend(renderer) {
